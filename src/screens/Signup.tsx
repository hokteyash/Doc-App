...
const Signup = ({navigation}: ScreenProps<'Signup'>) => {
  ...
  const {control} = useForm<signField>();
        ...
        <View
          ...
          <View>
            ...
            <ControlledInput
              ...
              inputConfig={{placeholder: 'Confirm Password'}}
              leftIcon={icons.password}
            />
            <Button
          ...
          <Poppins100 style={styles.footerText}>
            Have an account?{' '}
            <Poppins300 style={styles.footerText} onPress={goToLogin}>
              Sign In
            </Poppins300>
          </Poppins100>
        </View>
...
const styles = StyleSheet.create({
  ...
  btnStyle: {
    ...
    borderRadius: 10,
    marginTop: AppDimensions.windowWidth / 8,
    height: 53,
  },
  textStyle: {
